...
<body>
  ...
  <div class="main">
    <div class="welcome-box">
      ...
      <p>Manage your support tickets, submit new requests, and update your profile all in one place.</p>
    </div>

    <div class="dashboard-cards">
      <div class="card">
        <h3><i class="fas fa-ticket-alt"></i> Open Tickets</h3>
        <p>View and manage all your currently open support tickets in one convenient location.</p>
      </div>
      <div class="card">
        <h3><i class="fas fa-history"></i> Ticket History</h3>
        <p>Review your past support requests and see how they were resolved.</p>
      </div>
      <div class="card">
        <h3><i class="fas fa-plus"></i> New Ticket</h3>
        <p>Submit a new support request and get help with your technical issues.</p>
      </div>
    </div>
  </div>
